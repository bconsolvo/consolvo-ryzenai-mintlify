...
description: "Map high-precision weights and activations to lower-precision formats like BF16 and INT8 using AMD Quark."
---
...
The complete list of operations supported for different quantization types can be found in [Supported Operations](/ops_support).
...
- [Image Classification](https://github.com/amd/RyzenAI-SW/tree/main/CNN-examples/image_classification) using ResNet50 model on NPU
...
- Running INT8 model on NPU using [Getting Started Tutorial](/getstartex)
- [AMD Quark Tutorial](https://github.com/amd/RyzenAI-SW/tree/main/CNN-examples/quark_quantization) for Ryzen AI Deployment

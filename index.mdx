...
<CardGroup cols={3}>
  <Card title="Supported Configurations" href="/relnotes#supported-configurations" icon="circle-check">
    Hardware and OS matrix for Ryzen AI Software.
  </Card>
  <Card title="Installation Instructions" href="/inst" icon="download">
    Install the NPU driver and Ryzen AI Software on Windows.
  </Card>
  <Card title="Examples, Demos, Tutorials" href="/examples" icon="lightbulb">
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="/llm/high_level_python">Lemonade Python API*</a></td>
      <td><a href="/llm/server_interface">Lemonade Server Interface*</a></td>
      <td><a href="/hybrid_oga">OGA C++ Headers</a> <strong>OR</strong> <a href="https://github.com/ggml-org/llama.cpp">llama.cpp C++ Headers</a></td>
    </tr>
    <tr>

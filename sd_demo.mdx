...
1. Ensure the latest version of Ryzen AI and NPU drivers are installed. See [Installation Instructions](/inst).
...
Refer to the documentation on [xrt-smi configure](/xrt_smi#xrt-smi-configure) for additional information.

...
- Install NPU Drivers and Ryzen AI MSI installer. See [Installation Instructions](/inst) for more details.
...
To do this, the fine-tuned models must first be prepared for execution with the OGA flow. For instructions on how to do this, refer to the page about [Preparing OGA Models](/oga_model_prepare).

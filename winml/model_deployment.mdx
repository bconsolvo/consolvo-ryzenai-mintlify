...
The EP selection policy can be configured to use a specific execution provider or through general execution policy. For more details, refer to the Windows ML documentation on [Execution Providers](/winml/winml_ep).
...
For more details refer to the [model compilation and deployment](/modelrun) documentation.

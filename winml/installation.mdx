...
| Ryzen AI NPU                         | Supported processor with NPU. See [supported configurations](/relnotes#supported-configurations) in the release notes.      |
...
1. **Install NPU drivers:** Follow the [RAI installation instructions](/inst). Download and install the NPU driver (version 32.0.203.280 or newer) from the AMD Ryzen AI driver page.

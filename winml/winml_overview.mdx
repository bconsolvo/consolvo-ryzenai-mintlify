...
Use **Windows AI APIs** when built-in capabilities (OCR, image description, etc.) cover your scenario. Use **Foundry Local** when you want LLMs with minimal model preparation. Use the **Ryzen AI NPU-only flow** ([Model Compilation and Deployment](/modelrun)) when you need full control over ONNX Runtime without the Windows ML stack.

## Quick Links

| Topic                                                    | Page                                          |
| -------------------------------------------------------- | --------------------------------------------- |
| Prerequisites and installation                           | [Installation](/winml/installation)           |
| VitisAI EP model support (CNN, Transformer, LLM)         | [Model Support](/winml/model_support)         |
| Model deployment                                         | [Model Deployment](/winml/model_deployment)   |
| Model conversion and quantization (AI Toolkit)           | [Model Conversion](/winml/model_conversion)   |
| Execution providers (registration, EP policy, compilation) | [Execution Providers](/winml/winml_ep)      |
| Windows ML examples (CNN, Transformer, LLM)              | [Windows ML Examples](/winml/winml_example)   |
| Frequently asked questions                               | [FAQ](/winml/faq)                             |
| Troubleshooting                                          | [Troubleshooting](/winml/troubleshooting)     |

...
For more details on the `VitisAIExecutionProvider`-specific `provider_options`, see [Model compilation and deployment](/modelrun).
...
For more details on `VitisAIExecutionProvider` specific `provider_options` as shown in the reference documentation [Model compilation and deployment](/modelrun).

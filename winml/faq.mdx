...
**A:** Yes. When using a specific EP (e.g., VitisAI EP), you can pass provider options via the session configuration. See [Model Deployment](/winml/model_deployment) for examples. For VitisAI EP options, see [Model compilation and deployment](/modelrun).
